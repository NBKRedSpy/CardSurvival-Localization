...
Description:  
    Creates a TranslationData.tsv translation file which is used for a CSTI-ModLoader 
    mod which is only in Chinese.  

    Remember to translate the pipe delimited TranslationData.tsv to a comma delimited SimpEn.csv or the mod will not use the file.
